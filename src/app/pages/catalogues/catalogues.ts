...
/**
 * Marco común de las tres pantallas que se organizan por categoría: el catálogo de
 * categorías, el presupuesto que se fija sobre ellas y el catálogo de tags.
 *
...
export class CataloguesPage {
  /**
   * El mismo orden que tienen las tres opciones en el conmutador, para que la pantalla entre
   * por el lado hacia el que se deslizó la pastilla.
   */
  protected readonly destinations = ['/categories', '/budgets', '/tags'];
}
